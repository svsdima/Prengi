...
$(document).ready(function(){
    $('.carousel__bg').slick({
      ...
      $('.carousel__mac').slick({
        speed: 1500, /* Скорость перелистывания */
        // adaptiveHeight: true, /* Подстраивается под высоту картинки */
        // autoplay: true, /* Автопереключение слайдов */
        autoplaySpeed: 4000, /* Скорость автопереключения */
        slidesToShow: 1,
        ...
        dots: false,
        // dots:true,
        prevArrow: '<button type="button" class="slick-prev"><img src="icons/slick_left.png"></button>',
        nextArrow: '<button type="button" class="slick-next"><img src="icons/slick_right.png"></button>',
        responsive: [
            {
                breakpoint: 768,
                settings: {
